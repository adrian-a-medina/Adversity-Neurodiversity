...
p_load(dplyr, tidyr, tidyverse, knitr, ggplot2, Hmisc, broom, stats, kableExtra, webshot2)
...
```{r Logistic Regressions and Exponentiations, message=FALSE, warning=FALSE}
